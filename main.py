...
lang_accuracy_metric_top5 = torchmetrics.Accuracy(top_k=1).to(device)

clip_accuracy_metric = torchmetrics.Accuracy().to(device)
clip_accuracy_metric_top5 = torchmetrics.Accuracy(top_k=1).to(device)
...
accuracy_logs["Total Description-based Top-3 Accuracy: "] = 100*lang_accuracy_metric_top5.compute().item()

accuracy_logs["Total CLIP-Standard Top-1 Accuracy: "] = 100*clip_accuracy_metric.compute().item()
accuracy_logs["Total CLIP-Standard Top-3 Accuracy: "] = 100*clip_accuracy_metric_top5.compute().item()
